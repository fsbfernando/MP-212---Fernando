                    ...
                    if isfinite(Z) && Z>0
                        ...
                        if ~isempty(poseMsg)
                            ...
                            if size(points_3d_cam, 1) > 20
                                ...
                                centroid = mean(points_3d_cam, 1);
                                points_centered = points_3d_cam - centroid;
                                ...
                                % ---- pontos 3D transformados para base (mesma cor da máscara verde) ----
                                points_3d_base = (T_base_cam * [points_3d_cam, ones(size(points_3d_cam,1),1)]')';
                                points_3d_base = points_3d_base(:,1:3);

                                h_points = scatter3(ax3, points_3d_base(:,1), points_3d_base(:,2), points_3d_base(:,3), ...
                                    8, 'filled', ...
                                    'MarkerFaceColor', [0.3 0.9 0.3], ...  % verde claro coerente c/ máscara
